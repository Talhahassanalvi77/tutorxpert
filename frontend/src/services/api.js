...
export const adminAPI = {
  ...
  verifyTutor: (userId) => api.patch(`/admin/users/${userId}/verify`),
...
export const favoritesAPI = {
  ...
  add: (tutorId) => api.post('/favorites', { tutorId }),
  remove: (tutorId) => api.delete(`/favorites/${tutorId}`),
};
...
export const paymentsAPI = {
  ...
  confirmPayment: (bookingId, data) => api.post(`/payments/${bookingId}/confirm`, data),
  getTutorEarnings: () => api.get('/payments/earnings'),
